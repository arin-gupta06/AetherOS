  ...
  return (
    <div className="absolute inset-0 overflow-y-auto bg-cbct-bg text-cbct-text custom-scrollbar selection:bg-cbct-accent/30">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-20 flex flex-col items-center min-h-full z-10">
        ...
        >
           <p className="text-xs font-bold tracking-[0.2em] text-white/40 uppercase mb-8">Trusted by developers at</p>
           <div className="flex justify-center gap-16 grayscale opacity-60">
              <span className="text-lg font-bold font-serif text-white">Vercel</span>
              <span className="text-lg font-bold font-sans text-white">Stripe</span>
              <span className="text-lg font-bold font-mono text-white">GitHub</span>
